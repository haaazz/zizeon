<template>
  <div class="w-5/6 flex flex-col mx-auto">
    <h1
      class="text-center text-2xl font-bold text-green-600 sm:text-3xl mb-12 mt-12"
    >
      ✨커뮤니티✨
    </h1>
    <div class="grid justify-items-end">
      <button
        ...
        class="border border-gray-500 mb-2 rounded-lg p-1 bg-slate-50"
      >
    ...
    <div class="rounded-lg border w-full border-gray-200 mx-auto">
      <div class="overflow-x-auto rounded-t-lg">
        ...
        <div class="text-center mt-2 mb-2">
          <button @click="prevPage" :disabled="currentPage === 1" class="mr-2">
            이전
          </button>
