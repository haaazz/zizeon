<template>
  <div>
    <h1
      class="text-center text-2xl font-bold text-green-600 sm:text-3xl mb-6 mt-12"
    >
      ✨상품 추천✨
    </h1>
    <p class="text-center mb-8">
      각 상품명을 클릭하면 상세 정보 조회 페이지로 이동합니다.
    </p>

    <div class="w-5/6 text-center flex space-x-6 mx-auto justify-around mt-20">
      <div class="shadow-lg p-2 pl-5 pr-5 rounded-lg h-80 ml-20">
        <h3
          class="text-center text-xl font-bold text-green-600 sm:text-xl mb-6 mt-4"
        >
          추천 예금 목록
        </h3>
      ...
      <div class="shadow-lg p-2 pl-5 pr-5 rounded-lg h-80 mr-20">
        <h3
          class="text-center text-xl font-bold text-green-600 sm:text-xl mb-6 mt-4"
        >
          추천 적금 목록
